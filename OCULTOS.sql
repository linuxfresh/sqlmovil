SELECT DISTINCT TO_CHAR(i.D_FECPAR,'yyyy-mm-dd')  fecha, 
...
where (i.D_FECPAR between to_date('11/10/2019','dd/mm/yyyy') and to_date('31/10/2019','dd/mm/yyyy'))
...
--and t.C_ESTREG = 'A' 
and i.TIPITI_ID = 2 
AND I.N_ESANULADO = 0 and SUBSTR(i.C_HORPAR,5,1) not in ('1','2','3','4','6','7','8','9')
ORDER BY TO_CHAR(i.D_FECPAR,'yyyy-mm-dd') ,TURNO