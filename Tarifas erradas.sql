SELECT DISTINCT i.ITINERARIO_ID,TO_CHAR(i.D_FECPAR,'dd/mm/yyyy') fecha, 
...
where (i.D_FECPAR between sysdate-1 and sysdate+50)																	 --to_date('31/01/2019','dd/mm/yyyy'))
--OR (i.D_FECPAR between to_date('27/12/2017','dd/mm/yyyy') and to_date('27/12/2018','dd/mm/yyyy'))
and i.C_ESTREG = 'A' 
--and t.C_ESTREG = 'A' 
--and i.TIPITI_ID = 1 
AND I.N_ESANULADO = 0
and (N_TARIFA1<20 or N_TARIFA2<20)
and i.RUTA_IDMAYOR not in (630,602,594,629)--,607,609,767,608,613,766,19,290,4,275)--,33,270,304,3,267,274,269,270,271,266,267,268)
--and  i.ITINERARIO_ID not in (
--SELECT ITINERARIO_ID from VRTITINERARIO WHERE i.RUTA_IDMAYOR in (331,315) AND i.SERVICIO_ID = 29 and i.D_FECPAR between sysdate-1 and sysdate+30)
--and v.venpas_id is null
--and r.c_origen = 'VILLA RICA'
